  ...
  if (notFound) {
    return (
      <div className="max-w-2xl mx-auto">
        <div className="p-6 bg-card border border-border rounded-lg text-center" data-testid="survey-not-found">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="px-4 py-2 text-sm border border-border rounded-md bg-background text-foreground hover:bg-muted transition-colors"
          >
            Back to Surveys
          </button>
        </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6 space-y-4" data-testid="readonly-view">
          <div>
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-card border border-border rounded-lg p-6 space-y-5" noValidate>
        {/* Title */}
        <div>
          <label className="block text-sm font-medium text-foreground mb-1" htmlFor="survey-title">
        ...
        {/* Description */}
        <div>
          <label className="block text-sm font-medium text-foreground mb-1" htmlFor="survey-description">
            Description
          </label>
          <textarea
        ...
        {/* Welcome message */}
        <div>
          <label className="block text-sm font-medium text-foreground mb-1" htmlFor="survey-welcome">
            Welcome Message
          </label>
          <textarea
            id="survey-welcome"
        ...
        {/* End message */}
        <div>
          <label className="block text-sm font-medium text-foreground mb-1" htmlFor="survey-end">
            End Message
          </label>
          <textarea
            id="survey-end"
        ...
        {/* Default language */}
        <div>
          <label className="block text-sm font-medium text-foreground mb-1" htmlFor="survey-language">
            Default Language
          </label>
          <select
            id="survey-language"
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          <button
            ...
            onClick={handleCancel}
            disabled={isSubmitting}
            className="px-5 py-2 border border-border rounded-md text-sm font-medium bg-background text-foreground hover:bg-muted transition-colors disabled:opacity-50"
          >
            Cancel
          </button>
        </div>
